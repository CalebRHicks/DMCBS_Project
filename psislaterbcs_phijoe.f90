...
! use -gradient for downs to be consistent with bcs
   ...
   real(kind=r8) :: c,s,arg,v,dx(ndim)
   integer(kind=i4) :: i,k,ksh,j,kk
   real(kind=r8) :: f,df(3),d2f
!
